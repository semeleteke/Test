...
cl.login(token="Em4QFoGw1Xo9LQ4OSjxb.xgDz2yF3VyjqUApm+hoqYW.1rYjypMedJEb/h5gws8Z0a0730Q8Ad2SNCWi6n4Jj+U=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EmvYY9wdwRFufNBZuko0.TROjZ708oDUhvGTy6P6daa.4iDTCIa8eKhJiI26bL7GbYtLTmcVxdUG/ooeag0UurI=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="Emlhd8VPQGJrG2UuT4e4.otKQMI5k+PE//IFzpwGPHa.vmxIk/FybKgo5fPfZ3ldaEKuQP/1pz2gQVoJKIHP/BI=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Emqayz7cYqWSnTsyLjM5.RFraUH71tPPOqAHBP7pVLq.kPnmr4Fg2kbNtYwcVdws2HmTglaO2OA3WnoXB3ApngU=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EmL1Nfwn5kRpt8BJHU9b.noHEoLlmzd4DPgciLYnv6W.aNhSB+Bl30A7su4UU/kBdKGR3rJB50AMw4XgoyC+OCw=")
ks.loginResult()

print """login succes sayang"""
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""👊BOT SEMELEKETE👊
✰👊✡✡BOT NIKUNG✡✡👊✰
-==================-
◄]·👊·Menu For Public·👊·[►
[•]Adminlist
...
admin=["u104d0e5fa8022fd95517a0400cc85c08","u79b9b69b8ab605ec5040b504fd5f19cd","ue5fccbf73335b5d175627b6167f236f2","u94f957460c92a4715e80e5c469c799e4","u1fe3ab751c44e1368ae22b6f06732de2","ub4d7113b18fbcfa7f289d01de17b184c"] 
owner=["u79b9b69b8ab605ec5040b504fd5f19cd"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""тerima Kasih Sudah Menambahkan Aku Jadi Teman kakak 😘""",
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key","key1","key2"]:
                if wait["lang"] == "JP":
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  cl.sendText(msg.to,"list admin")
                  mc = "||✍Admin👊👊✡✡BOT SEMELEKETE✡✡👊👊||\n✡✡=====================✡✡\n"
                  for mi_d in admin:
    ...
    #-------------=SC AllBio=---------------- Ganti Bio Semua Bot Format => Allbio: SUKA SUKA KALIAN :D
            elif "Allbio:" in msg.text: #gak kepake
              if msg.from_ in owner:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah Sayang")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Sudah Sayang")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Sudah Sayang")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup Sayang")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Sudah Sayang")
                    else:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "%s\n\n%s\n\nThese uesrs have seen at the lastseen point(｀・ω・´)\n\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "%s\n\n%s\n\nThese uesrs have seen at the lastseen point(｀・ω・´)\n\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
#-----------------------------------------------
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Boss","Semelekete","Join say"]: #Panggil Semua Bot
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Pulang Boss","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Nikung Say" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Nikung Say","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot off","Op bye"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
            elif msg.text in ["Dong","dong","dongg"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Jim","Absen bot","Absen dulu","Respon"]:
              if msg.from_ in owner:
                cl.sendText(msg.to,"Hadir Sayang")
                ki.sendText(msg.to,"Iya Sayang")
                kk.sendText(msg.to,"Siap Sayang")
                kc.sendText(msg.to,"yes Sayang")
                ks.sendText(msg.to,"Sayang kamu")
                cl.sendText(msg.to,"Semua Udah Hadir Sayang\nSiap Protect Group\nAman Gak Aman Yang Penting Asolole")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid':'u79b9b69b8ab605ec5040b504fd5f19cd'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Ketceh 😜")
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Good bye (｀・ω・´) " + str(ginfo.name))
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by 👊👊BOT SEMELEKETE👊👊👈\n\n™👊👊BOT SEMELEKETE👊👊™")
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====HADIR=====\n[★]Selfbot ‮@💕͡➴͜☆✍【4G1D4】ٳৡ [★]===[★]👊👊😊BOT SEMELEKETE😊👊👊[★]===")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like [★]👊👊😊BOT SEMELEKETE😊👊👊[★]")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====HADIR=====\n[★]👊👊😊BOT SEMELEKETE😊👊👊[★]")
                    print "Like"
                except:
                    pass
            else:
                print "Status Sudah di Like Sayang"
